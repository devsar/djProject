...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('tasks_task', 'spend', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2))

        # Changing field 'Task.remaining'
        db.alter_column('tasks_task', 'remaining', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Task.remaining'
        db.alter_column('tasks_task', 'remaining', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2))
    ...
    models = {
        ...
        'tasks.task': {
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['projects.Project']"}),
            'remaining': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '8', 'decimal_places': '2', 'blank': 'True'}),
            'spend': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '8', 'decimal_places': '2', 'blank': 'True'}),
